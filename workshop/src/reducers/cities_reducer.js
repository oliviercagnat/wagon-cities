// 1: We create the cities_reducer and do export default to export it then.
// 2: the reducer function receives the action, state is null.
// 3: For displaying the list of cities:
// - 1: the reducer receives no specific action.
// - 2: it triggers then 'default' and return the list of cities


// Here no need to setCities through Redux.
// We directly return the list of cities.
